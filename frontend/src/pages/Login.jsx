...
const Login = () => {
  ...
  const handleForgotPassword = async () => {
    ...
    if (result.success) {
      ...
      navigate('/forgot-password', { state: { email: formData.email, sent: true } });
    } else {
      showToast(result.error, 'error');
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-gray-50 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm font-medium mt-2">Log in to your Cohive workspace.</p>
        </div>
        ...
        <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-xl shadow-purple-50">
          ...
          <p className="mt-8 text-center text-xs text-gray-400 font-medium">
            ...
            <Link to="/register" className="text-[#8b5cf6] font-bold hover:underline">
              Sign up
            </Link>
          </p>
        </div>
